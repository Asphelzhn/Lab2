				...
				<form class="form-horizontal" action="edit" >
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" maxlength="128"  class="form-control" id="inputTitle"
									name="newBook.title" placeholder=<s:property value="aBook.title" /> value=<s:property value="aBook.title" />>
							</div>
						</div>
						<div class="form-group">
							<label for="inputAuthor" class="col-lg-2 control-label">作者</label>
							<div class="col-lg-10">
        						<s:select  Class="form-control" list="authors" listKey="authorId" listValue="name" name="newBook.authorId"  headerKey="#aBook.authorId" headerValue="-请选择-" >
   								</s:select>
								<s:if test="warring==0">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" maxlength="128" class="form-control" id="inputPublisher"
									name="newBook.publisher" placeholder=<s:property value="aBook.publisher" /> value=<s:property value="aBook.publisher" />>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="date" class="form-control" id="inputDate"
									name="newBook.publishDate" placeholder=<s:property value="aBook.publisherDate" /> value=<s:property value="aBook.publishDate" />>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" maxlength="128" pattern="[0-9]*" class="form-control" id="inputPrice"
									name="newBook.price" placeholder=<s:property value="aBook.price" /> value=<s:property value="aBook.price" />>
							</div>
						</div>
						<div class="form-group">
							<label for="inputIsbn"  class="col-lg-2 control-label">ISBN</label>
							<div class="col-lg-10">
								<input type="text" readonly="readonly" maxlength="13"  pattern="[0-9]*" class="form-control" id="inputIsbn"
									 name="newBook.isbn"  value=<s:property value="aBook.isbn" />>
									<s:if test="warring==1">
						...
						<div class="form-group">
							<div class="col-lg-10 col-lg-offset-2">
								...
								<input type="hidden" name="aAuthor.name" value=<s:property value="aAuthor.name" />>
								<input type="submit" value="提交" class="btn btn-primary" />
								<a class="btn btn-info "
								href="search?aBook.isbn=<s:property value="#x.isbn"/>&aAuthor.name=<s:property value="aAuthor.name"/>">放弃修改</a>
							</div>
						</div>
					</fieldset>
				</form>
